...
class BlogPost(models.Model):
    ...
    class Status(models.IntegerChoices):
        ...
        PUBLISHED = 2           # the only valid status for posts to be shown to normal users
        DISABLED = 3            # staff or editors disabled post to address some issue
    ...
    author = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='posts_made', on_delete=models.CASCADE)
    editor = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='posts_edited', on_delete=models.SET_NULL,
...
class Illustration(models.Model):
    ...
    """
    post = models.ForeignKey(BlogPost, on_delete=models.CASCADE, related_name='illustrations')
    ...
    def upload_illustration(cls, image):
        ...
        upload_illustration doesn't create an Illustration instance and doesn't make a database entry.
    ...
    def assign_illustration(img_url, post, save=True):
        """
        Create an Illustration instance out of preview picture in media/tmp directory.
